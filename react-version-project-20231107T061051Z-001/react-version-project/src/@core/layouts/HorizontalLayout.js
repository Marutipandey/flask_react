...
const HorizontalLayout = props => {
  ...
  return (
    ...
    >
      ...
      {!isHidden ? (
        <div className='horizontal-menu-wrapper' style={{width: 'calc(100% - 316px)', top: '-2px', zIndex: '999', left: '122px', position: 'fixed'}}>
          <Navbar
            tag='div'
            expand='sm'
            light={skin !== 'dark'}
