...
const TradeTabs = lazy(() => import('../../views/pages/trades'))
const StockTabs = lazy(() => import('../../views/pages/stock'))
const StrategiesTabs = lazy(() => import('../../views/pages/strategies'))
const ReportApp = lazy(() => import ('../../views/pages/report'))
const RobotApp = lazy(() => import('../../views/pages/robot'))
const PMSTabs = lazy(() => import('../../views/pages/pms'))
const AccessPageTabs = lazy(() => import('../../views/pages/access'))
